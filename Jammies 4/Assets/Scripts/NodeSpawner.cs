...
public class NodeSpawner : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Node nodeEnd = new Node(12, stageBoss, NodeType.Boss);
        Node node12 = new Node(11, new Node[] { nodeEnd }, enemies3, NodeType.Normal);
        Node node11 = new Node(10, new Node[] { nodeEnd }, enemies2, NodeType.Normal);
        Node node10 = new Node(9, new Node[] { node12 }, enemies2, NodeType.Normal);
        Node node9 = new Node(8, new Node[] { node11 }, NodeType.Heal);
        Node node8 = new Node(7, new Node[] { node11 }, stageHard2, NodeType.Hard);
        Node node7 = new Node(6, new Node[] { node10 }, enemies3, NodeType.Normal);
        Node node6 = new Node(5, new Node[] { node10 }, stageHard1, NodeType.Hard);
        Node node5 = new Node(4, new Node[] { node9 }, NodeType.Heal);
        Node node4 = new Node(3, new Node[] { node8 }, stageHard3, NodeType.Hard);
        Node node3 = new Node(2, new Node[] { node6, node7 }, enemies1, NodeType.Normal);
        Node node2 = new Node(1, new Node[] { node4, node5, node6 }, enemies2, NodeType.Normal);
        Node nodeStart = new Node(0, new Node[] { node2, node3 }, NodeType.Heal);
